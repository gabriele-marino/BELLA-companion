...
tree1 <- read.nexus("outputs/summaries/eucovid/BELLA/mcc.nexus")
tree2 <- read.nexus("outputs/summaries/eucovid/GLM/mcc.nexus")
...
pdf("outputs/figures/eucovid/cophylo.pdf", width = 20, height = 12)
