...
The mapping from input predictors to migration rates was parameterized using a generalized linear model (GLM) and a BELLA model consisting of two hidden layers with 16 and 8 neurons, respectively.
